    ...
    public static void main ( String[] args ) {
        try {
            ...
            while ( myReader.hasNextLine() ) {
                String rucksack = myReader.nextLine();
                contents1 = rucksack.substring( 0, rucksack.length() / 2 ).toCharArray();
                contents2 = rucksack.substring( rucksack.length() / 2 ).toCharArray();
